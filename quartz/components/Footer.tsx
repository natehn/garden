        ...
        <p>
          <a href="https://hew.tt" target='_blank'>⌂</a> | <a href="https://webring.xxiivv.com/#icons" target="_blank" class="inline-icon">
            <img
              ...
              height="11.5"
            />
          </a> | <a href="mailto:nathan@hew.tt" target='_blank' rel="me">✉</a> | <a href="https://hew-tt.atabook.org" target='_blank'>Guestbook</a> | © {year} Nathan Hewitt (made with <a href="https://quartz.jzhao.xyz" target='_blank'>Quartz</a>) 
        </p> 
        </div>
      </footer>
    )
